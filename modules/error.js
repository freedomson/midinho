...
export class Error extends LitElement {
  ...
  render() {
    return html`
      ...
      <div id="error-info">
        <small>
          Private Ollama requires an Ollama instance running on your computer.
          <br/>
          <a href="https://ollama.com">Ollama</a> is a tool for running your private LLMS.
        </small>
        </br></br>
        <article>
          <h1>Step 1</h1>
          <small>
            ...
            <br/>
            Click <a href="https://ollama.com/download">here</a> to download Ollama.
          </small>
        </article>
        <article>
          <h1>Step 2</h1>
